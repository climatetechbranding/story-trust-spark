...
import { Plus, QrCode, BarChart3, Settings } from "lucide-react";
...
const Dashboard = () => {
  ...
  const stories = [
    {
      id: "1",
      name: "Product Sustainability Story",
      status: "Published",
      views: 1234,
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate("/builder")}>
